...
//ADD TANGENTS
		for(uint32_t i = 0; i < indices.size(); i += 3)
		{
			...
			const FPoint4& p0 = vertices[index0].position;
			const FPoint4& p1 = vertices[index1].position;
			const FPoint4& p2 = vertices[index2].position;
			const FVector2& uv0 = vertices[index0].uv;
			const FVector2& uv1 = vertices[index1].uv;
			const FVector2& uv2 = vertices[index2].uv;

			const FVector3 edge0 = p1.xyz - p0.xyz;
			const FVector3 edge1 = p2.xyz - p0.xyz;
